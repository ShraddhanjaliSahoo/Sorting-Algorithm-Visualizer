...
algomenu = ttk.Combobox(
    options_frame,
    textvariable=select_algorithm,
    values=['Bubble Sort', 'Merge Sort', 'Selection Sort', 
            'Insertion Sort', 'Quick Sort', 'Heap Sort'],
    width=15
)
algomenu.current(0)
algomenu.grid(row=0, column=1, padx=10, pady=10)   # <-- FIXED LINE

sortingspeed = Scale(options_frame, from_=0.1, to=2.0, length=100, digits=2, resolution=0.2,
                     orient=HORIZONTAL, label="Sorting Speed")
